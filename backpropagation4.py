...
class NeuralNetworkApp:
    ...
    def export_pdf(self):
        ...
        self.plot_graph(save_as_image=True, image_filename="output_graph.png")
        
        # Insertar la gráfica en el PDF
        pdf.image("output_graph.png", x=10, y=100, w=150)
    ...
    def plot_graph(self, save_as_image=False, image_filename=None):
        if self.output is None or not self.outputs_per_iteration:
            messagebox.showwarning("Graficar", "Primero entrene la red neuronal.")
            return

        # Graficar la salida en cada iteración
        plt.figure()
